            ...
            if (staza.endsWith('.pdf')) {
                el.sertifikatModalTelo.innerHTML = `
                    <div class="modal-loading-wrap">
                        ...
                        <iframe src="${putanja}" onload="document.getElementById('sertifikat-spinner')?.classList.add('sakriven')"></iframe>
                    </div>`;
